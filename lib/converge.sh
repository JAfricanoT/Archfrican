...
ARCHFRICAN_MODULES="00-base 10-gpu 15-desktop-services 20-niri-desktop 25-plasma-desktop 30-dev 35-apps 40-theming 45-print 50-snapshots 55-multiboot 60-security 65-gaming 67-virtualization 70-hygiene"
...
module_inputs() {                 # module_inputs <name>
  ...
  case "$1" in
    ...
    67-virtualization) printf ' packages/virtualization.txt' ;;
